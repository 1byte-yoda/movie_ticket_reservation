...
class AccountTest(TestCase):
    def test_create_account(self):
        account = AccountModel(email="test_email@sample.com",
    ...
    def test_account_json(self):
        ...
        expected_output = {
            "id": None, "email": "test_email@sample.com",
            "password": "some_password", "type": "user",
            "created_at": "2020-08-02 08:30:00",
            "updated_at": "2020-08-02 08:30:00"
        }
        self.assertEqual(account.json(), expected_output,
