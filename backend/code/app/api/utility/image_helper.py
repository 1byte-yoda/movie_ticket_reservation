...
#  Resolve the import error in werkzeug https://stackoverflow.com/questions/61628503/flask-uploads-importerror-cannot-import-name-secure-filename
...
def get_base_name(file: Union[str, FileStorage]) -> str:
