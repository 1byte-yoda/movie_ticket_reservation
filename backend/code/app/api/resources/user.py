...
from ..models.province import ProvinceModel
...
class UserRegisterResource(Resource):
    ...
    def post(cls):
        ...
        barangay_data = user_data["location"]["barangay"]
        city_data = barangay_data["city"]
        province_data = city_data["province"]
        province = ProvinceModel(name=province_data["name"])
        city = CityModel(name=city_data["name"], province=province)
